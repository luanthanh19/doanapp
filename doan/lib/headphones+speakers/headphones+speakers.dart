...
class TaiNgheLoa extends StatefulWidget {
  const TaiNgheLoa({super.key});

  @override
  State<TaiNgheLoa> createState() => _TaiNgheLoaState();
}

class _TaiNgheLoaState extends State<TaiNgheLoa> {
  String _searchText = '';
